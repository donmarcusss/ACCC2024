...
<div class="card shadow-lg">
    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <tbody>
              ...
              <tr>
                <td> <select class="form-control text-white text-muted">
                    <option> Shocks & Struts </option>
                    <option> Oil Change  </option>
                    <option> Tune Up </option>
                    <option> Radiator </option>
        ...
        <div class="px-10" style="">
            ...
            Total: 5,898.00 <br><br>
            <a href="job-order" class="text-decoration-none text-white">
            <button type="button" class="btn btn-light btn-icon-text" style="" >
                <i class="mdi"></i>Go Back </button> </a>
            </div>
