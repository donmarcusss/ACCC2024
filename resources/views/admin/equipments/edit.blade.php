...
<div class="card shadow-lg">
    <div class="card-body">
        ...
        <BR>
            ...
            <form action="{{route('admin/equipments/update' , $equipments->id )}}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
                @method('PUT')
            
                <div class="form-group">
                  <label for="exampleFormControlInput1" >Equipment Name</label> <br>
                  <input value="{{$equipments->equipment_name}}" name="equipment_name" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Equipment Price</label>
                    <input value="{{$equipments->equipment_price}}" name="equipment_price" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Equipment Quantity</label>
                    <input value="{{$equipments->equipment_quantity}}" name="equipment_quantity" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
