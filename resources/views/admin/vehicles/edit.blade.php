...
<head>
  <title> Autofixx Car Care Center | Vehicles Edit</title>
</head>
...
<div class="card shadow-lg">
    <div class="card-body">
        ...
        <BR>
            ...
            <form action="{{route('admin.vehicles.update' , $vehicles->id )}}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
                @method('PUT')
                ...
                <br>
                    ...
                    <input value="{{ optional($vehicles)->vehicle_type }}" name="vehicle_type" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                    ...
                    <br>
                      ...
                      <input value="{{ optional($vehicles)->vehicle_manufacturer }}" name="vehicle_manufacturer" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                      ...
                      <input value="{{ optional($vehicles)->vehicle_model }}" name="vehicle_model" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
