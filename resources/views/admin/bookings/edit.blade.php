...
<head>
  <title> Autofixx Car Care Center | Edit Booking</title>
</head>
...
<div class="card shadow-lg">
    <div class="card-body">
        ...
        <BR>
            ...
            <form action="{{route('admin.bookings.update' , $bookings->id )}}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
                @method('PUT')
                ...
                <br>
                    ...
                    <input value="{{ optional($bookings)->vehicle_type }}" name="vehicle_type" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                    ...
                    <br>
                      ...
                      <input value="{{ optional($bookings)->vehicle_manufacturer }}" name="vehicle_manufacturer" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                      ...
                      <input value="{{ optional($bookings)->vehicle_model }}" name="vehicle_model" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                ...
                <div class="form-group">
                  ...
                  <input value="{{ optional($bookings)->description }}" name="description" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
