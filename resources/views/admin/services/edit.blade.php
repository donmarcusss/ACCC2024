...
<div class="card shadow-lg">
    <div class="card-body">
        ...
        <BR>
            ...
            <form action="{{route('admin/services/update' , $services->id )}}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
                @method('PUT')
            
                <div class="form-group">
                  <label for="exampleFormControlInput1" >Service Name</label> <br>
                  <input value="{{$services->service_name}}" name="service_name" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                </div>
                <div class="form-group">
                    <label for="exampleFormControlInput1">Service Price</label>
                    <input value="{{$services->service_price}}" name="service_price" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
