    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
          <table class="table">
            ...
            <!-- Modal toggle -->
<button data-modal-target="default-modal" data-modal-toggle="default-modal" class="nav-link btn btn-success create-new-button" id="createbuttonDropdown" data-bs-toggle="dropdown" aria-expanded="false" href="forms">+ Create a new Service</button>
</button>
<br>
    ...
    <div class="relative p-4 w-full max-w-2xl max-h-full">
        ...
        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
            ...
            <div class="p-4 md:p-5 space-y-4">
              ...
              <form action="{{ route('admin/services/save') }}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
              ...
              {{-- <div>
                ...
                <input type="integer" name="service_price" id="service_price" class="bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="" required="">
            </div> --}}
...
<br><br>
            ...
            <tbody>
              @foreach ($services as $service)
                ...
                <td>
                   <a  class="btn btn-warning "  aria-expanded="false" href="{{ route('admin/services/edit', ['id'=>$service->id]) }}">Edit</a>  
                   {{-- <a type="button" class="btn btn-danger " href="{{ route('admin/services/delete', ['id'=>$service->id]) }}  aria-expanded="false">Delete</a> --}}
                ...
                <div class="relative p-4 w-full max-w-2xl max-h-full">
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="flex items-center p-4 md:p-5 border-t border-gray-200 rounded-b dark:border-gray-600">
                          ...
                          <a data-modal-hide="second-modal" type="submit"   href="{{ route('admin/services/delete', ['id'=>$service->id]) }}" class="text-white bg-red-700 hover:bg-red-800 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center ">Delete</a>
