...
<div class="card shadow-lg">
    <div class="card-body">
        ...
        <BR>
            ...
            <form action="{{route('secretary/appointments/update' , $bookings->id )}}" method="POST" class="space-y-4 md:space-y-6" >
                @csrf
                @method('PUT')
                ...
                <div class="form-group">
                  ...
                  <select name="status" id="status" class="form-control" required style="color: white;">
                      ...
                      <option value="pending" {{ old('status', $bookings->status) == 'pending' ? 'selected' : '' }} >Pending</option>
                      <option value="approved" {{ old('status', $bookings->status) == 'approved' ? 'selected' : '' }}>Approved</option>
                      <option value="cancelled" {{ old('status', $bookings->status) == 'cancelled' ? 'selected' : '' }}>Cancelled</option>
                  </select>
              </div>

                <div class="form-group">
                  <label for="exampleFormControlInput1" >User ID</label> <br>
                  <input value="{{$bookings->user_id}}" name="user_id" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="ID of the user example: 24">
                </div>
                {{-- <div class="form-group">
                  <label for="exampleFormControlInput1">Email</label>
                  <input value="{{$bookings->user->email}}" name="email" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                </div> --}}
                <div class="form-group">
                    <label for="exampleFormControlInput1">First Name</label>
                    <input value="{{optional($bookings->user)->first_name }}" name="first_name" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Last Name</label>
                    <input value="{{$bookings->user->last_name}}" name="last_name" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Vehicle Type</label>
                    <input value="{{$bookings->vehicle_type}}" name="vehicle_type" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Vehicle Manufacturer</label>
                    <input value="{{$bookings->vehicle_manufacturer}}" name="vehicle_manufacturer" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
                  <div class="form-group">
                    <label for="exampleFormControlInput1">Vehicle Model</label>
                    <input value="{{$bookings->vehicle_model}}" name="vehicle_model" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>

                  <div class="form-group">
                    <label for="exampleFormControlInput1">Description</label>
                    <input value="{{$bookings->description}}" name="description" style="color: white;" type="text" class="form-control" id="exampleFormControlInput1" placeholder="name@example.com">
                  </div>
