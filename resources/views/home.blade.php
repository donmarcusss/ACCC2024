<x-app-layout>
    ...
    <x-slot name="header">
        <title> Autofixx Car Care Center | Home</title>
...
<body >
    ...
    <main class="content-normal mx-40 pt-10  lg:max-w-7xl ">
        <div class="grid gap-6 lg:grid-cols-2 lg:gap-8 items-stretch">
            <a
                href="https://laravel.com/docs"
                id="docs-card"
                class="flex flex-col items-start gap-6 overflow-hidden rounded-lg bg-white shadow-[0px_14px_34px_0px_rgba(0,0,0,0.08)] ring-1 ring-white/[0.05] transition duration-300 hover:text-black/70 hover:ring-black/20 focus:outline-none focus-visible:ring-[#FF2D20] md:row-span-3 lg:p-10 lg:pb-10"
            >
            ...
            >
                ...
                <div class="pt-3 sm:pt-5">
                    <h2 class="text-xl font-semibold text-black">Book Now</h2>
