      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
            ...
            <div class="profile-desc">
              <div class="profile-pic">
                ...
                <div class="profile-name">
                  <h5 class="mb-0 font-weight-normal">Mechanic</h5>
                  <span></span>
                </div>
              </div>
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../mechanic/dashboard">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../mechanic/schedule">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="../mechanic/job-order">
              <span class="menu-icon">
          ...
          {{-- <li class="nav-item menu-items">
            <a class="nav-link" data-bs-toggle="collapse" href="../mechanic/" aria-expanded="false" aria-controls="auth">
              <span class="menu-icon">
              ...
              <li class="nav-item dropdown border-left">
                ...
                <div class="dropdown-menu dropdown-menu-right navbar-dropdown preview-list" aria-labelledby="notificationDropdown">
                  ...
                  <a class="dropdown-item preview-item">
                    ...
                    <div class="preview-item-content">
                      <p class="preview-subject mb-1">Launch mechanic</p>
                      <p class="text-muted ellipsis mb-0"> New mechanic wow! </p>
                    </div>
                  </a>
                  <div class="dropdown-divider"></div>
              ...
              <li class="nav-item dropdown">
                <a class="nav-link" id="profileDropdown" href="#" data-bs-toggle="dropdown">
                  <div class="navbar-profile">
                    <img class="img-xs rounded-circle" src="{{ Vite::asset('resources/assets/images/autofixx logo.png') }}" alt="">
                    <p class="mb-0 d-none d-sm-block navbar-profile-name">mechanic</p>
